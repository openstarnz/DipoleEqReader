...
from dipoleq_reader import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "dipoleq-reader"
...
html_title = f"dipoleq-reader v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/jguterl/DipoleEqReader",
            "html": """
